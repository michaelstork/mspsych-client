					...
					<div className="panel-item eval-info-panel-item fourth-year-elective-info">
						<div className="input-container">
							...
							<select
								...
								<option value="Consult/Liason">
									Consult/Liason
								</option>
								<option value="Outpatient Psychiatry Department">
									Outpatient Psychiatry Department
								</option>
								<option value="Psychiatric Emergency Room">
						...
						<div className="input-container">
							...
							<select
								...
								<option value="Sinai Student">
									Sinai Student
								</option>
								<option value="Visiting Student">
									Visiting Student
								</option>
							</select>
						</div>
					...
					<div className="panel-item eval-info-panel-item fourth-year-elective-info">
						<div className="input-container">
							...
							<input
								...
								value={this.state.electiveStartDate}
								onChange={this.handleInfoItemChange}
								required />
						</div>
						<div className="input-container">
							...
							<input
								type="text"
								name="electiveLength"
								value={this.state.electiveLength}
								onChange={this.handleInfoItemChange}
								required />
						</div>
					</div>
