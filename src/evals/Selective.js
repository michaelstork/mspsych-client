				...
				<EvalFormInfo
					...
					<div className="panel-item eval-info-panel-item">
						<div className="input-container">
							...
							<select onChange={this.handleInfoItemChange}
								name="selective"
								required>
								<option value=''>
									Select
								</option>
								<option value="Psychiatry Consultation/Liaison Service">
									Psychiatry Consultation/Liaison Service
								</option>
								<option value="Psychiatry Emergency Services">
									Psychiatry Emergency Services
								</option>
								<option value="Continuing Day Treatment Program">
									Continuing Day Treatment Program
								</option>
								<option value="Geriatric Psychiatry Clinic">
									Geriatric Psychiatry Clinic
								</option>
								<option value="Child Psychiatry Consultation/Liaison Service">
									Child Psychiatry Consultation/Liaison Service
								</option>
								<option value="IMA Psychiatry">
									IMA Psychiatry
								</option>
								<option value="Jack Martin Clinic">
									Jack Martin Clinic
								</option>
								<option value="other">
									Other
